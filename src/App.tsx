  ...
  return (
    <AuthProvider>
      <UserProvider>
        <Router>
          <ScrollToTop />
          <div className="min-h-screen flex flex-col font-sans relative overflow-hidden bg-[#f4f7f5]">
        {/* Decorative Light Effects */}
        <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-[#FF4E00]/10 blur-[120px] rounded-full z-0 pointer-events-none"></div>
